...
# def main_compare2(folder1, folder2, matrix1, matrix2):
...
#             del sorted_P2_files[max_sim_element["pair"].split(":")[1]]  # Удаляем уже использованный файл из словаря
...
def main_compare888(folder1, folder2, matrix1, matrix2):
